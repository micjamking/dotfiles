...
defaults write NSGlobalDomain AppleHighlightColor -string "0.95 0.50 0.2"
...
defaults write com.apple.screencapture location -string "${HOME}/Google Drive/Documents/screenshots"
